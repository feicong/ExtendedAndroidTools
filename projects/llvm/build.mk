...
# Build all LLVM libraries statically for static linking
LLVM_EXTRA_CMAKE_FLAGS += -DLLVM_BUILD_LLVM_DYLIB=OFF -DLLVM_LINK_LLVM_DYLIB=OFF
endif
...
LLVM_BRANCH_OR_TAG = llvmorg-20.1.8
